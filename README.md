...
> > > `io` is a `chatIO.IO` like object that will be instantiated anytime a new user connects. When the first message is received from a given user, `io` called with the initial message as a parameter.
